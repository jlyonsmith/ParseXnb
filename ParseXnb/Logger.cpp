...
void Logger::WriteBytes(char const* name, vector<uint8_t> const& bytes)
{
...
void Logger::WriteEnum(char const* name, int32_t value, char const* const* enumValues)
{
    if ((value >= 0) && (find(enumValues, enumValues + value, (const char *)NULL) == enumValues + value))
    {
